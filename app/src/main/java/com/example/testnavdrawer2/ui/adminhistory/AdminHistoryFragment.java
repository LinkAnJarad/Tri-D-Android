package com.example.testnavdrawer2.ui.adminhistory;
...
public class AdminHistoryFragment extends Fragment {
    ...
    private AdminHistoryViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AdminHistoryViewModel.class);
